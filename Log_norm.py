...
logger = logging.getLogger('lognormal')  

# set log level
logger.setLevel(logging.INFO)

# define file handler and set formatter
file_handler = logging.FileHandler('30_norm_50000_3000_0.log')
...
for i in range(0, 3):
        ...
        df_train, df_test, a_tr, a_tt = log_norm(n = 50000, p = 3000, r = 0, 
                        b0 = 0, b1 = np.concatenate((np.array([0.0001]*1500), np.array([0]*1500))), sig = 2,
...
pd.DataFrame({'acc_tr_lgb': acc_tr_lgb,
             ...
             'c_tt' : c_tt,
             'time_lgb': time_lgb,
             'time_xgb': time_xgb}).to_pickle('30_norm_50000_3000_0.pkl')
...
# define file handler and set formatter
file_handler = logging.FileHandler('30_norm_50000_3000_0.5.log')
formatter    = logging.Formatter('%(asctime)s : %(levelname)s : %(name)s : %(message)s')
file_handler.setFormatter(formatter)
...
for i in range(0, 3):
        ...
        df_train, df_test, a_tr, a_tt = log_norm(n = 50000, p = 3000, r = 0.5, 
...
pd.DataFrame({'acc_tr_lgb': acc_tr_lgb,
             ...
             'c_tt' : c_tt,
             'time_lgb': time_lgb,
             'time_xgb': time_xgb}).to_pickle('30_norm_50000_3000_0.5.pkl')
